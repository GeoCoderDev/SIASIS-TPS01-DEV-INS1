...
export type GradoPorNivel<N extends NivelEducativo> =
  N extends NivelEducativo.PRIMARIA ? GradosPrimaria :
  N extends NivelEducativo.SECUNDARIA ? GradosSecundaria :
  never;

export type NOMBRE_ARCHIVO_LISTA_ESTUDIANTES<N extends NivelEducativo = NivelEducativo> =
